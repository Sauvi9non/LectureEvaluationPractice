...
<%
	...
	if(request.getParameter("searchType") != null) {
		lectureDivide = request.getParameter("searchType");
	}
	if(request.getParameter("search") != null) {
		lectureDivide = request.getParameter("search");
	}
	if(request.getParameter("pageNumber") != null) {
		lectureDivide = request.getParameter("pageNumber");
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div id="navbar" class="collapse navbar-collapse">
			...
			<form action="./index.jsp" method="get" class="form-inline my-2 my-lg-0">
				<input type="text" name="search" class="form-control mr-sm-2" type="search" placeholder="검색창" aria-label="Search">
	...
	<section class="container"> <!-- 본문 같은 내용을 넣을 때 사용 -->
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			<select name="LectureDivide" class="form-control mx-1 mt-2">
				...
				<option value="교양" <% if(lectureDivide.equals("전공")) out.println("selected"); %>>교양</option>
				<option value="기타" <% if(lectureDivide.equals("전공")) out.println("selected"); %>>기타</option>
			</select>
...
%>
		...
		<div class="card-header bg-light">
			<div class="row">
				<div class="col-8 text-left"><%= evaluation.getLectureName() %> &nbsp;</div><small><%= evaluation.getProfessorName() %></small></div>
		...
		<div class="card-body">
			...
			<small><%= evaluation.getLectureYear()%>년 <%= evaluation.getSemesterDivide() %>학기</small>
			</h5>
			<p>
			...
			<div class="row">
				<div class="col-9 text-left">
					성적 <span style="color: red;"><%= evaluation.getTotalScore() %></span>
					강의 <span style="color: red;"><%= evaluation.getLectureScore() %></span>
					종합 <span style="color: red;"><%= evaluation.getLikeCount() %></span>
